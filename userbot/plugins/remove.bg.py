...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Connecting to official AnonCracker server and analysing that img ...")
        try:
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by HarshTech".format(ms))
    else:
